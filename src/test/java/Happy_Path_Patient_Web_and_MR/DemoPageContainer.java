package java.Happy_Path_Patient_Web_and_MR;
...
//                try {
//                    byte[] imageBytes = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
//                    scenario.attach(imageBytes, "image/png", "Failure Screenshot");
//                } catch (Exception e) {
//                    System.out.println("Screenshot skipped - session might be closed.");
//                }
//            }
//
//            System.out.println("\n Scenario Outline: " + scenario.getName());
