...
public class AppointmentsPage extends BasePage {
    ...
    @FindBy(how = How.XPATH, using = "//button[@title='Go to the next page']")
    protected WebElement elmntNextPage;

    @FindBy(how = How.XPATH, using = "//button[@title='Go to the next page'][@aria-disabled='true']")
    ...
    @FindBy(how = How.XPATH, using = "//h1[text()='Appointments']//following::div/i")
    ...
    protected String elmntAppointmentPreScreening1 = "//span[contains(text(),'Do any of these apply to you?')]";
    ...
    protected String elmntFamilyMember = new StringBuilder().append("(//span[contains(text(),'")
            .append("<<REPLACEMENT>>").append("')])[2]").toString();

    protected String elmntFamilyMember1 = new StringBuilder().append("//span[contains(text(),'")
            .append("<<REPLACEMENT>>").append("')]").toString();
    ...
    @FindBy(how = How.XPATH, using = "//div[@class='mat-mdc-tab-links']")
    ...
    @FindBy(how = How.XPATH, using = "//i[@class='icon-cent-calendar-date']")
    protected WebElement elmntDateIcon;
    ...
    protected String elmntBookingType = new StringBuilder().append("//span[contains(text(),'")
            .append("<<REPLACEMENT>>").append("')]").toString();
    ...
    protected String elmntDatePicker = new StringBuilder().append("//td[@class='mat-calendar-body-cell-container ng-star-inserted']//child::button[@class='mat-calendar-body-cell']/span[normalize-space(text())='")
            .append("<<REPLACEMENT>>").append("']").toString();

    //td[@class='mat-calendar-body-cell-container ng-star-inserted']//child::button[@class='mat-calendar-body-cell']/span[normalize-space(text())='']

    protected String elmntSlots = new StringBuilder().append("((//span[text()='")
    ...
    @FindBy(how = How.XPATH, using = "//div[contains(@class,'desktop-view')]//span[contains(text(),'Continue')]")
    protected WebElement btnConfirmDesktop;

    @FindBy(how = How.XPATH, using = "//div[contains(text(),'Future appointment(s)')]")
    protected WebElement elmtFutureAppointmentHeader;

    @FindBy(how = How.XPATH, using = "//p[text()='Auto Autochrisc1 (1) has future appointment(s). ']")
    protected WebElement elmtAppointmentPopup;

    @FindBy(how = How.XPATH, using = "//button[contains(text(),'CANCEL')]")
    protected WebElement elmtCancelButton;

    //div[contains(@class,'desktop-view')]//span[contains(text(),'Confirm')]
    ...
    @FindBy(how = How.XPATH, using = "//h2[contains(text(),'Terms & Conditions')]")
    protected WebElement chkAcceptandTermsHeader;

    @FindBy(how = How.XPATH, using = "//button[contains(text(),'I AGREE')]")
    protected WebElement chkAcceptandTermsIAgreebutton;
    ...
    @FindAll({
            ...
            @FindBy(how = How.XPATH, using = "//button[@class='btn-primary with-green mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base ng-star-inserted']//span[contains(text(),'Confirm & Continue')]"),//With Fees
            @FindBy(how = How.XPATH, using = "//button[@class='btn-primary with-green mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base ng-star-inserted']//span[contains(text(),'Pay & Continue')]"),//PayOnline
    ...
    @FindAll({
            ...
            @FindBy(how = How.XPATH, using = "//mat-dialog-container//div/div[contains(text(),'Please join the Video Call just 15 mins before your appointment time at')]")

            })
    protected WebElement elmntAppointmentsisNotForTodayPopup;


    protected String elmntVideoBookingType = new StringBuilder().append("//label[contains(text(),'")
            .append("<<REPLACEMENT>>").append("')]").toString();
    ...
    @FindBy(how = How.XPATH, using = "//div[@class='mat-mdc-card-header-text']/mat-card-title")
    ...
    @FindBy(how = How.XPATH, using = "//div[contains(@class,'expansion-panel-primary-content')]//mat-icon[contains(text(),'videocam')]")
    ...
    @AndroidFindBy(xpath = "//android.widget.CheckedTextView[@text='28']")
    ...
    @FindBy(how = How.XPATH, using = "(//button[@class='mat-mdc-tooltip-trigger btn btn-primary btn-block m-t-20 p-cancelBtn mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base mat-mdc-tooltip-disabled ng-star-inserted']//span[text()=' Cancel Appointment'])[1]")
    ...
    protected String elmntVideoAppointment = new StringBuilder().append("//td[contains(text(),'")
            .append("<<REPLACEMENT1>>")
            .append("')]//following::td//following::td//span[contains(text(),'")
            .append("<<REPLACEMENT2>>")
            .append("')]").toString();

    //td[contains(text(),'24 Feb 2024')]//following::td//following::td//span[contains(text(),'Join')]
...
//            jsClick(elmntBookAppointment);
    ...
    public boolean selectLocation(String strLocation) {
        ...
        try {
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
            jsScrollIntoView(elmntPatientLocationCenter);
            waitForElementClickable(elmntPatientLocationCenter);
            jsClick(elmntPatientLocationCenter);
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
    ...
    public boolean selectAppointmentIsFor(String strFamilyMember) {
        ...
        try {
            ...
            System.out.println(">>>>>"+elmntSelectFamilyMember);
...
//            elmntReason.sendKeys(strReason);
            driver.switchTo().activeElement().sendKeys(strReason);
...
//            elmntReasonTextBox.sendKeys(strReason);
    ...
    public boolean selectTypeOfPhoneAppointment(String strBookingType) {
        boolean blResult = false;
        try {
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
            waitForElementClickable(elmntBookingTypeContainer);
            WebElement elmntTypeOfAppointment = waitForElement(By.xpath(elmntPhoneBookingType.replace("<<REPLACEMENT>>", strBookingType)));
            System.out.println(">>>>>>>"+elmntTypeOfAppointment);
            click(elmntTypeOfAppointment);
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
            blResult = true;
    ...
    public boolean selectFutureDateOnCalender(String strFutureDate) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("elmntDate"+elmntDate);
                verifyElement(elmntDate);
                waitForElementClickable(elmntDate);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
                waitForElement(elmntDateIcon);
                jsClick(elmntDate);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
...
//                click(VerifyConfirmButton);
    ...
    public boolean verifyPatientPhoneAppointmentsLocation(List<String> strData){
        ...
        try{
            ...
            jsClick(elmntPhoneAppointmentIcon);
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
    ...
    public boolean verifyNoOfAppointmentAllowedPerdayPopup() {
        boolean blResult = false;
        try {
            if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
                waitForElement(elmtFutureAppointmentHeader);
                verifyElement(elmtFutureAppointmentHeader);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
                waitForElement(elmtAppointmentPopup);
                verifyElement(elmtAppointmentPopup);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
                waitForElement(elmtCancelButton);
                click(elmtCancelButton);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
                blResult = true;
            }
...
//                strConvertedTime = "0" + strConvertedTime;
    ...
    public boolean VerifyTypeOfVideoAppointmentPopupNotDisplayed() {
        boolean blResult = false;
        try {
    ...
    public boolean acceptTermsAndConditionsForAppointment() {
        ...
        try {
            if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
                ...
                waitForElement(chkAcceptandTermsHeader);
                verifyElement(chkAcceptandTermsHeader);
                waitForElement(chkAcceptandTermsIAgreebutton);
                click(chkAcceptandTermsIAgreebutton);
                waitForElementDisappear(driver, By.xpath(elmntSpinner));
...
//            waitForElement(elmntBookingTypeContainer);
    ...
    public boolean selectProvider(String strProvider) {
        ...
        try {
            ...
            takeScreenshot(driver);
            waitForElement(elmntDateIcon);
            blResult =verifyElement(elmntDateIcon);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return blResult;
...
//                swipeHorizontalMobileView(elmntProviders);
    ...
    public boolean verifyFutureAppointmentDatesInGridNewMethod() {
        ...
        do {
            ...
            waitForSeconds(3);
            if (verifyElement(elmntNextPage)) {
...
//        click(elmntMaxValue);
    ...
    public void clickFirstIcon(List<String> data) {
//        List<String>Datevalue=TestDataUtil.getListOfValue(data);
        String strDatePattern1 = "dd MMM yyyy";
        String strDate = TestDataUtil.getValue(data.get(0));
        String strDateValue = DateUtil.getDate(strDate, strDatePattern1);
        System.out.println(">>>>>>>>>strDateValue"+strDateValue);
        WebElement elmntAppointmentDetails = waitForElement(By.xpath(elmntVideoAppointment.replace("<<REPLACEMENT1>>", strDateValue).replace("<<REPLACEMENT2>>", data.get(1))));
        System.out.println(">>>>>>>>>elmntAppointmentDetails"+elmntAppointmentDetails);
        waitForElement(elmntAppointmentDetails);
        verifyElement(elmntAppointmentDetails);
        jsClick(elmntAppointmentDetails);
    }
...
//                }
            ...
            if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
                ...
                jsScrollUp();
                Select DateExpiryYear = new Select(driver.findElement(By.id("DateExpiry_2")));
                DateExpiryYear.selectByVisibleText("28");
                System.out.printf("Successflly select DateExpiryMonth");
...
//            Add Calender Verification
            ...
            WebElement elmntReservationDetails = waitForElement(By.xpath(btnCancelForCreatedAppointment
                    ...
                    .replace("<<REPLACEMENT3>>", lstDetails.get(1))));
            System.out.println("TEST" + lstDetails.get(1));
            System.out.println("elmntReservationDetails :: "+elmntReservationDetails);
            verifyElement(elmntReservationDetails);
            takeScreenshot(driver);
            click(elmntReservationDetails);
            waitForSeconds(3);
...
//            System.out.println(strFinalOutDateTime);
    ...
    public boolean verifyApprovedForTheCreatedAppointment(List<String> lstDetails) {
        boolean blResult = false;
                    ...
                    if (btnCancel.size() > 0) {
                        ...
                        for (int i = 1; i <= btnCancel.size(); i++) {
                            if (verifyElement(elmntfuturetab)) {
                                ...
                                System.out.println("Already user in Upcoming Appointments page");
                            }
                            System.out.println("TEST");
                            waitForSeconds(5); //wait until 'loader'  loading
...
//            waitForElementToAppear(driver,By.xpath(elmntSpinner));
    ...
    public boolean verifyDefaultLocationDoctorNamesforphoneAppointments(List<String> strData,List<String> VM03PraticeDoctorNames){
        ...
        try{
            ...
            WebElement elmntProviderName = waitForElement(By.xpath(elmntProviderNames.replace("<<REPLACEMENT>>",TestDataUtil.getValue(VM03PraticeDoctorNames.get(2)))));
                System.out.println("elmntProviderName"+elmntProviderName);
                if (strdata.equals(TestDataUtil.getValue(VM03PraticeDoctorNames.get(2)))){
                    jsScrollIntoView(elmntProviderName);
    ...
    public boolean verifyRuleADoctorNames(List<String> strData,List<String> Auto_Pra_Loc1_DoctorNames){
        boolean blresult = false;
        try{
    ...
    public boolean verifyRuleCDoctorNames(List<String> strData,List<String> Auto_Pra_Loc1_DoctorNames){
        boolean blresult = false;
        try{
            System.out.println(">>>strData>>"+strData);
            System.out.println(">>>Auto_Practice_Loc1_DoctorNames>>"+Auto_Pra_Loc1_DoctorNames);
    ...
    public boolean verifyRuleDdoctorNames(List<String> strData,List<String> Auto_Pra_Loc1_DoctorNames){
        boolean blresult = false;
        try{
            System.out.println(">>>strData>>"+strData);
            System.out.println(">>>Auto_Practice_Loc1_DoctorNames>>"+Auto_Pra_Loc1_DoctorNames);
    ...
    public boolean verifyRuleEDoctorNames(List<String> strData,List<String> Auto_Pra_Loc1_DoctorNames){
        boolean blresult = false;
        try{
            System.out.println(">>>strData>>"+strData);
            System.out.println(">>>Auto_Practice_Loc1_DoctorNames>>"+Auto_Pra_Loc1_DoctorNames);
    ...
    public boolean verifyNonRistrickDefaultLocationDoctorNames(List<String> strData,List<String> Auto_Pra_Loc1_DoctorNames){
        boolean blresult = false;
        try{
            System.out.println(">>>Auto_Practice_Loc1_DoctorNames>>"+Auto_Pra_Loc1_DoctorNames);
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
    ...
    public boolean verifyPhoneAppointmentAnyLocationDoctorNames(List<String> strData,List<String> VM03PraticeDoctorNames,List<String> VM03Pratice2DoctorNames){
        ...
        try{
            ...
            if (verifyElement(By.xpath(elmntLocation.replace("<<REPLACEMENT>>",TestDataUtil.getValue(strData.get(11)))))) {
                ...
                WebElement elmntSelectVM03Location = waitForElementClickable(By.xpath(elmntLocation.replace("<<REPLACEMENT>>",TestDataUtil.getValue(strData.get(10)))));
                System.out.println("elmntSelectVM03Location"+elmntSelectVM03Location);
                jsScrollIntoView(elmntSelectVM03Location);
                jsClick(elmntSelectVM03Location);
                waitForSeconds(3);
                declineCovidPreScreeningPopup();
                System.out.println("Successfully Verified the Rule B");
                System.out.println("Successfully Verified the Rule C");
...
System.out.println(">>>>>>>>>>>>>VerifyMyAppointmentTableDatalstDetails"+lstDetails);
    ...
    public boolean selectViewClear() {
        ...
        try {
            ...
            mouseClick(elmntclearButton);
            waitForElementDisappear(driver, By.xpath(elmntSpinner));
            blResult = verifyElement(elmntclearButton);
        } catch (Exception e) {
