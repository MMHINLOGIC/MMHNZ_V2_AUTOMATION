...
//            Assert.assertTrue(demoPageContainer.homePage.MobileDashboardIconsVerification());
...
//            Assert.assertTrue(demoPageContainer.homePage.MobileDashboardIconsVerification());
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.homePage.DashboardIconsVerification());
    ...
    public void asAUserIAmOnPatientHomePage() {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.homePage.clickPatientDashBoard());
            Assert.assertTrue(demoPageContainer.homePage.verifyHomePageOfMMHPortal());
        }
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILEVIEW")) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILE")) {
            ...
            Assert.assertTrue(demoPageContainer.homePage.clickPatientDashBoardForMobile());
            Assert.assertTrue(demoPageContainer.homePage.verifyHomePageOfMMHPortal());
        }
    ...
    @And("I enter the Flexible Slot visit appointment details {string}")
    public void iEnterTheFlexibleSlotVisitAppointmentDetails(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.VeriflyAllTabElementIsNotDisplayed());
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAdditional(TestDataUtil.getValue(lstAppointmentDetails.get(8))));
    ...
    @And("I should see booked Flexible Slot appointment displayed under the future tab {string}")
    public void iShouldSeeBookedFlexibleSlotAppointmentDisplayedUnderTheFutureTab(String strAppointmentSummary) {

        List<String> lstDetails = TestDataUtil.getListOfValue(strAppointmentSummary);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyCreatedFlexibleAppointmentInFutureAppointmentTab(lstDetails));
        }
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILE")) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILEVIEW")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyMobileCreatedFlexibleAppointmentInFutureAppointmentTab(lstDetails));

        }
    }

    @And("I enter the Flexible Slot video appointment details {string}")
    public void iEnterTheFlexibleSlotVideoAppointmentDetails(String strVideoAppointmentDetails) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAdditional(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectTypeOfAppointment(TestDataUtil.getValue(lstAppointmentDetails.get(4))));
    ...
    @And("I enter the Flexible Slot phone appointment details {string}")
    public void iEnterTheFlexibleSlotPhoneAppointmentDetails(String strHealthCenter) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAdditional(TestDataUtil.getValue(lstAppointmentDetails.get(10))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectTypeOfAppointment(TestDataUtil.getValue(lstAppointmentDetails.get(4))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyFutureAppointmentDatesInGrid());
    ...
    public void iEnterThePhoneAppointmentDetails(String strHealthCenter) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectTypeOfPhoneAppointment(TestDataUtil.getValue(lstAppointmentDetails.get(4))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAvialableSlotDateTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectPhoneCode(TestDataUtil.getValue(lstAppointmentDetails.get(7))));
...
//    }
    ...
    public void SelectTheMedicationDetails(String strMedicationDetails) {
        System.out.println("\nMedicationDetails >>> :" + TestDataUtil.getListOfValue(strMedicationDetails));
...
//            System.out.println(">> TestDataUtil list2 : "+list2);
    ...
    public void iShouldSeeAllTheRecallsRemainderEntriesFromHealthCenterMedicineDetailsInAGridView(List<String> RecallsRemainderDetails) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILEVIEW")) {
            for (String String : RecallsRemainderDetails) {
                System.out.println(">> TestDataUtil.getListOfValue(String) : " + TestDataUtil.getListOfValue(String));
                Assert.assertTrue(demoPageContainer.myHealthRecordsPage.VerifyMobileRecallsRemaindersTableData(TestDataUtil.getListOfValue(String)));
            }
        }
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILE")) {
            for (String String : RecallsRemainderDetails) {
...
//            demoPageContainer.myHealthRecordsPage.RefreshPage();
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILEVIEW")) {
            ...
            demoPageContainer.myHealthRecordsPage.enterPrescriptionEndDate();
            Assert.assertTrue(demoPageContainer.myHealthRecordsPage.selectMobilePrescriptiondropdown(TestDataUtil.getValue(listCreateData.get(6))));
...
//        Assert.assertTrue(demoPageContainer.appointmentsPage.verifyAllIcons(lstIcons));
    ...
    public void asAUserLaunchTheAndLoginWith(String strURL) {
        ...
        Assert.assertTrue(demoPageContainer.messagesPage.clickBetaLoginButton());
...
//       Assert.assertTrue(demoPageContainer.messagesPage.selectHealthCenter(TestDataUtil.getValue(lstMessageDetails.get(0))));
        Assert.assertTrue(demoPageContainer.messagesPage.ProviderHealthCenter(TestDataUtil.getValue(lstMessageDetails.get(0))));
        ...
        Assert.assertTrue(demoPageContainer.messagesPage.selectServiceNamePatient1(TestDataUtil.getValue(lstMessageDetails.get(2))));
...
//    }
    ...
    public void iClickTheReceivedMessageAndIToTheReceivedMessage(String strReplyMessage) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.messagesPage.replyToPatientReceivedMessage(lstReplyMessage.get(5), lstReplyMessage.get(1)));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    public void iNavigateToBookAppointmentSelectDefaultLocation(String strLocation) {
        ...
        Assert.assertTrue(demoPageContainer.homePage.clickPatientBookAppointment());
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(data.get(0))));
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.ProviderselectLocation(TestDataUtil.getValue(data.get(1))));
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
    }
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    public void iNavigateToBookAppointmentSelectDefaultLocationAnd(String strLocation, String AppointmentReason) {
        ...
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(data.get(0))));
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(data.get(1))));
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(AppointmentReason)));
    }
...
//        System.out.println(">>>>>StrAppointmentIsForDropdownDetails>>"+TestDataUtil.getListOfValue(StrAppointmentIsForDropdownDetails));
    ...
    @And("I select the friends and family dropdown enter the visit appointment details {string}")
    public void iSelectTheFriendsAndFamilyDropdownEnterTheVisitAppointmentDetails(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.EnterFamilyMemberName(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectTypeOfAppointment(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(8))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAvialableSlotDateTime(TestDataUtil.getValue(lstAppointmentDetails.get(7))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
        }
    }
    ...
    @And("I navigate to Book Appointment then I enter the visit appointment details {string} and {string}")
    public void iNavigateToBookAppointmentThenIEnterTheVisitAppointmentDetailsAnd(String strAppointments, String strHealthCenter) {
        Assert.assertTrue(demoPageContainer.homePage.clickAppointmentsExpandIcon());
        Assert.assertTrue(demoPageContainer.appointmentsPage.navigateToBookAppointmentPage(strAppointments));
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
    ...
    @Then("I enter the phone appointment details {string} and verify Appointment Session Name as MMHPA will be displayed Phone Appointments")
    public void iEnterThePhoneAppointmentDetailsAndVerifyAppointmentSessionNameAsMMHPAWillBeDisplayedPhoneAppointments(String strHealthCenter) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.veriflyPhoneAvialableSlotTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.enterPhoneNumber(TestDataUtil.getValue(lstAppointmentDetails.get(8))));
    ...
    @Then("I enter the phone appointment details {string} and verify Appointment Session Name as BLANK will be displayed Phone Appointments")
    public void iEnterThePhoneAppointmentDetailsAndVerifyAppointmentSessionNameAsBLANKWillBeDisplayedPhoneAppointments(String strHealthCenter) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.veriflyRule2PhoneAvialableSlotTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(9))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.enterPhoneNumber(TestDataUtil.getValue(lstAppointmentDetails.get(8))));
    ...
    @Then("I select the Medication details for Sent Script by Pharmacy {string} {string}")
    public void iSelectTheMedicationDetailsForSentScriptByPharmacy(String strMedicationDetails, String SelectScriptDropDownDetails) {
        System.out.println("MedicationDetails >>> :" + strMedicationDetails);
        List<String> lstMedicationDetails = TestDataUtil.getListOfValue(strMedicationDetails);
        System.out.println("lstMedicationDetails >>> " + lstMedicationDetails);
        System.out.println("Size Of lstMedicationDetails >>> " + lstMedicationDetails.size());
...
//       Assert.assertTrue(demoPageContainer.messagesPage.selectHealthCenter(TestDataUtil.getValue(lstMessageDetails.get(0))));
    ...
    @And("I enter the phone appointment details {string} and Verify the Default Location Any ProviderName and payment {string} {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheDefaultLocationAnyProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames, String VM03ProviderNames2) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientPhoneAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPhoneAppointmentAnyLocationDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames), TestDataUtil.getListOfValue(VM03ProviderNames2)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @And("I enter the video appointment details {string} and Verify the Default Location Any ProviderName and payment {string} {string}")
    public void iEnterTheVideoAppointmentDetailsAndVerifyTheDefaultLocationAnyProviderNameAndPayment(String strVideoAppointmentDetails, String AutoPat1ProviderNames, String Autopat2ProviderNames) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strVideoAppointmentDetails);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientVideoAppointmentsLocation(TestDataUtil.getListOfValue(strVideoAppointmentDetails)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyVideoAppointmentAnyLocationDoctorNames(TestDataUtil.getListOfValue(strVideoAppointmentDetails), TestDataUtil.getListOfValue(AutoPat1ProviderNames), TestDataUtil.getListOfValue(Autopat2ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @And("I navigate to Book Appointment Page Enter the Visit Appointments Details {string}")
    public void iNavigateToBookAppointmentPageEnterTheVisitAppointmentsDetails(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
    ...
    @And("I navigate to Book Appointment Page Enter the Video Appointments Details {string}")
    public void iNavigateToBookAppointmentPageEnterTheVideoAppointmentsDetails(String strHealthCenter) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickPatientBookAppointment());
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
    ...
    public void iShouldSeeAppointmentIsNotForTodayPopup(String Date) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            demoPageContainer.appointmentsPage.clickFirstIcon(TestDataUtil.getListOfValue(Date));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyAppointmentIsNotForTodayPopup());
        }
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILEVIEW")) {
    ...
    @Then("Verify if Location {string} and Provider are Displayed based on Rule B {string} {string}")
    public void verifyIfLocationAndProviderAreDisplayedBasedOnRuleB(String strHealthCenter, String VM03ProviderNames, String VM032ProviderNames) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
    ...
    @Then("Verify if Location {string} and Provider are Displayed based on Rule C {string}")
    public void verifyIfLocationAndProviderAreDisplayedBasedOnRuleC(String strHealthCenter, String VM03ProviderNames) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            System.out.printf("lstAppointmentDetails" + lstAppointmentDetails);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
    ...
    @Then("Verify if Location {string} and Provider are Displayed based on Rule D {string}")
    public void verifyIfLocationAndProviderAreDisplayedBasedOnRuleD(String strHealthCenter, String VM03ProviderNames) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            System.out.printf("lstAppointmentDetails" + lstAppointmentDetails);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
    ...
    @And("I enter the visit appointment details {string} and I click confirm button")
    public void iEnterTheVisitAppointmentDetailsAndIClickConfirmButton(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
    ...
    @And("I navigate to the {string} Future Appointments page and I click cancel button for the created appointment {string}")
    public void iNavigateToTheFutureAppointmentsPageAndIClickCancelButtonForTheCreatedAppointment(String strAppointments, String strAppointmentCancel) {
        List<String> lstDetails = TestDataUtil.getListOfValue(strAppointmentCancel);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.homePage.clickAppointmentsExpandIcon());
            Assert.assertTrue(demoPageContainer.appointmentsPage.navigateToWebFutureAppointmentPage(strAppointments));
            demoPageContainer.appointmentsPage.verifyApprovedForTheCreatedAppointment(lstDetails);
//            Assert.assertTrue(demoPageContainer.appointmentsPage.entereasonForCancelAppointment());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.clickCancelYourAppointment());
        }
    ...
    @And("I enter the visit appointment details {string} and verify No of Appointment allowed perday")
    public void iEnterTheVisitAppointmentDetailsAndVerifyNoOfAppointmentAllowedPerday(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAvialableSlotDateTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.clickConfirmButton());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyNoOfAppointmentAllowedPerdayPopup());

        }
    }

    @And("I enter the visit appointment details {string} Without Enter Reason and I click confirm button")
    public void iEnterTheVisitAppointmentDetailsWithoutEnterReasonAndIClickConfirmButton(String strHealthCenter) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
    ...
    @And("I navigate to Book Appointment Page Enter the Video Appointments Detail then verify Book Appointment Popup is not Displayed {string}")
    public void iNavigateToBookAppointmentPageEnterTheVideoAppointmentsDetailThenVerifyBookAppointmentPopupIsNotDisplayed(String strVideoAppointmentDetails) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strVideoAppointmentDetails);
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickPatientBookAppointment());
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
        ...
        Assert.assertTrue(demoPageContainer.appointmentsPage.selectAvialableSlotDateTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickConfirmButton());
        Assert.assertTrue(demoPageContainer.appointmentsPage.VerifyTypeOfVideoAppointmentPopupNotDisplayed());
    }

    @And("I navigate to Book Appointment Page Enter the Video Appointments Detail {string}")
    public void iNavigateToBookAppointmentPageEnterTheVideoAppointmentsDetail(String strVideoAppointmentDetails) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strVideoAppointmentDetails);
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickPatientBookAppointment());
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
        Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
    ...
    public void asAUserIAmOnBeatingTheBluesPage() {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("MOBILE")) {
            demoPageContainer.homePage.BTBvisit();
            demoPageContainer.homePage.verifyMobileBTBLoginPage();
    ...
    public void asASelfRegisteredUserIAmOnBTBWebsiteLoginPage() {
        demoPageContainer.homePage.SelfRegisteredPateintBTBWebsite();
        demoPageContainer.homePage.verifyBTBWebsiteLoginPage();
    ...
    public void asASelfRegisteredUserIAmOnBetaMMHLoginPage() {
        demoPageContainer.homePage.visit();
        demoPageContainer.homePage.clickBetaLoginButton();
    }

    @Then("I should see user successfully logs in to the BTB Home Page")
    public void iShouldSeeUserSuccessfullyLogsInToTheBTBHomePage() {
        Assert.assertTrue(demoPageContainer.homePage.verifyHomePageOfBTB());
    }

    @Then("I should see user successfully logs in to the Provider BTB Portal")
    public void iShouldSeeUserSuccessfullyLogsInToTheProviderBTBPortal() {
        Assert.assertTrue(demoPageContainer.homePage.verifyHomePageOfProviderBTB());


    }

    @And("I click on Create an Individual Account and Enter the BTB Self Registered form")
    public void iClickOnCreateAnIndividualAccountAndEnterTheBTBSelfRegisteredForm() {
        demoPageContainer.homePage.BTBSignButton();
        demoPageContainer.homePage.ClickcreateanIndividualAccount();

    }

    @And("I click on Create an Individual Account and Enter the BTB Self Registered form {string}")
    public void iClickOnCreateAnIndividualAccountAndEnterTheBTBSelfRegisteredForm(String Data) {
        List<String> SelfRegisterData = TestDataUtil.getListOfValue(Data);
        System.out.println(">>>" + TestDataUtil.getListOfValue(Data));
        demoPageContainer.homePage.BTBSignButton();
        Assert.assertTrue(demoPageContainer.homePage.ClickcreateanIndividualAccount());
        Assert.assertTrue(demoPageContainer.homePage.EnterFirstName(TestDataUtil.getValue(SelfRegisterData.get(0))));
        Assert.assertTrue(demoPageContainer.homePage.EnterLastName(TestDataUtil.getValue(SelfRegisterData.get(1))));
        Assert.assertTrue(demoPageContainer.homePage.EnterEmail(TestDataUtil.getListOfValue(Data)));
        Assert.assertTrue(demoPageContainer.homePage.EnterPassword(TestDataUtil.getValue(SelfRegisterData.get(3))));
        Assert.assertTrue(demoPageContainer.homePage.EnterConfirmPassword(TestDataUtil.getValue(SelfRegisterData.get(3))));
        Assert.assertTrue(demoPageContainer.homePage.SelectDOB(TestDataUtil.getValue(SelfRegisterData.get(4))));
        Assert.assertTrue(demoPageContainer.homePage.SelectGenderDropDown(TestDataUtil.getValue(SelfRegisterData.get(5))));
        Assert.assertTrue(demoPageContainer.homePage.SelectEthnicityDropDown(TestDataUtil.getValue(SelfRegisterData.get(6))));
        Assert.assertTrue(demoPageContainer.homePage.SelectCheckBox1());
        Assert.assertTrue(demoPageContainer.homePage.SelectCheckBox2());
    ...
    public void asAExistingMMHProviderUserIAmOnBTBWebsiteLoginPage() {

        demoPageContainer.homePage.ExistingBTBProvidervisit();
        demoPageContainer.homePage.clickBetaLoginButton();
    }

    @Then("I should see user successfully logs in to the Existing Provider BTB Portal")
    public void iShouldSeeUserSuccessfullyLogsInToTheExistingProviderBTBPortal() {
        Assert.assertTrue(demoPageContainer.homePage.verifyHomePageOfProviderPortal());

    }

    @Given("As a Patient Self Registered user I am on BTB Website Login Page")
    public void asAPatientSelfRegisteredUserIAmOnBTBWebsiteLoginPage() {
        demoPageContainer.homePage.SelfRegisteredPateintBTBWebsite();
//        demoPageContainer.homePage.verifyBTBWebsiteLoginPage();
    }

    @Then("I Navigate Gmail and click the Confirm your registration user is navigated to Manage My Health portal {string}")
    public void iNavigateGmailAndClickTheConfirmYourRegistrationUserIsNavigatedToManageMyHealthPortal(String Gmaildata) {
        List<String> Data = TestDataUtil.getListOfValue(Gmaildata);
        Assert.assertTrue(demoPageContainer.homePage.VisitGmail(Data.get(0)));
...
//            Assert.assertTrue(demoPageContainer.homePage.navigateToHomePage());
    ...
    @And("I enter the phone appointment details {string} and Verify the Rule B Default Location Default ProviderName and payment {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheRuleBDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientPhoneAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRuleBDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @And("I enter the visit appointment details {string} and Verify the Rule C Default Location Default ProviderName and payment {string}")
    public void iEnterTheVisitAppointmentDetailsAndVerifyTheRuleCDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientvisitAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRuleCDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @Then("I enter the phone appointment details {string} and Verify the Rule C Default Location Default ProviderName and payment {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheRuleCDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @Then("I enter the phone appointment details {string} and Verify the Rule D Default Location Default ProviderName and payment {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheRuleDDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientPhoneAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRuleDdoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @And("I enter the visit appointment details {string} and Verify the Rule D Default Location Default ProviderName and payment {string}")
    public void iEnterTheVisitAppointmentDetailsAndVerifyTheRuleDDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @Then("I enter the phone appointment details {string} and Verify the Rule E Default Location Default ProviderName and payment {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheRuleEDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames) {
        ...
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientPhoneAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRuleEDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @Then("I should see details of created appointment {string} {string} and I verify booked appointment displayed under the future tab {string}")
    public void iShouldSeeDetailsOfCreatedAppointmentAndIVerifyBookedAppointmentDisplayedUnderTheFutureTab(String strAppointmentDetails, String strFutureDate, String strAppointmentSummary) {
        List<String> lstDetails = TestDataUtil.getListOfValue(strAppointmentDetails);
        List<String> lstDetail = TestDataUtil.getListOfValue(strAppointmentSummary);
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickConfirmButton());
        Assert.assertTrue(demoPageContainer.appointmentsPage.verifyDetailsOfCreatedAppointment(lstDetails, (TestDataUtil.getValue(strFutureDate))));
...
//        Assert.assertTrue(demoPageContainer.repeatPrescription.selectPharmacyBySavedListForDelivery(lstMedicationDetails.get(3), lstMedicationDetails.get(4)));
    ...
    @And("I enter the visit appointment details {string} and Verify the Any Locations Any ProviderName and payments {string} {string} {string} {string}")
    public void iEnterTheVisitAppointmentDetailsAndVerifyTheAnyLocationsAnyProviderNameAndPayments(String strHealthCenter, String VM03ProviderNames, String VM032ProviderNames, String StrAppointmentIsForDropdownDetails, String Appointment_Details) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            List<String> lstAppointmentDetails1 = TestDataUtil.getListOfValue(Appointment_Details);
            System.out.printf("lstAppointmentDetails" + lstAppointmentDetails);
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifydeclineCovidPreScreeningPopupDisplayed());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifydeclineCovidPreScreeningPopupDisplayed());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientvisitAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientDoctorNamesforvisitappoinments(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames), TestDataUtil.getListOfValue(VM032ProviderNames)));
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifydeclineCovidPreScreeningPopupDisplayed());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifyAppointmentIsForFamilyDropdownDetails(TestDataUtil.getListOfValue(StrAppointmentIsForDropdownDetails)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.EnterFamilyMemberName(TestDataUtil.getValue(lstAppointmentDetails1.get(3))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectRelationship(TestDataUtil.getValue(lstAppointmentDetails1.get(4))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyandselectAccidentInjuryRelated());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectTypeOfAppointment(TestDataUtil.getValue(lstAppointmentDetails.get(4))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectProvider(TestDataUtil.getValue(lstAppointmentDetails.get(6))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectFutureDateOnCalender(TestDataUtil.getValue(lstAppointmentDetails.get(7))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAvialableSlotDateTime(TestDataUtil.getValue(lstAppointmentDetails.get(5))));
    ...
    @Then("I see page navigated to the payment option and I enter the card details and confirm payment {string}")
    public void iSeePageNavigatedToThePaymentOptionAndIEnterTheCardDetailsAndConfirmPayment(String strPayOnlineDetails) {
    ...
    @And("I enter the visit appointment details {string} and Verify Restricted providers are displayed Check Payments {string}")
    public void iEnterTheVisitAppointmentDetailsAndVerifyRestrictedProvidersAreDisplayedCheckPayments(String strHealthCenter, String VM03ProviderNames) {
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
            System.out.printf("lstAppointmentDetails" + lstAppointmentDetails);
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            ...
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientvisitAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRistrickDefaultLocationDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(lstAppointmentDetails.get(1))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.declineCovidPreScreeningPopup());
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectAppointmentIsFor(TestDataUtil.getValue(lstAppointmentDetails.get(2))));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectReasonForBooking(TestDataUtil.getValue(lstAppointmentDetails.get(3))));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyZeroPayments());
    ...
    @And("I enter the phone appointment details {string} and Verify the Rule B Default Location Default ProviderName and payment {string} {string}")
    public void iEnterThePhoneAppointmentDetailsAndVerifyTheRuleBDefaultLocationDefaultProviderNameAndPayment(String strHealthCenter, String VM03ProviderNames, String StrAppointmentIsForDropdownDetails) {

        List<String> lstAppointmentDetails = TestDataUtil.getListOfValue(strHealthCenter);
        if (System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "").equalsIgnoreCase("BROWSER")) {
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifydeclineCovidPreScreeningPopupNotDisplayed());
            Assert.assertTrue(demoPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(lstAppointmentDetails.get(0))));
            Assert.assertTrue(demoPageContainer.appointmentsPage.VerifydeclineCovidPreScreeningPopupNotDisplayed());
            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyPatientPhoneAppointmentsLocation(TestDataUtil.getListOfValue(strHealthCenter)));
//            Assert.assertTrue(demoPageContainer.appointmentsPage.verifyRuleBDoctorNames(TestDataUtil.getListOfValue(strHealthCenter), TestDataUtil.getListOfValue(VM03ProviderNames)));
...
//            Assert.assertTrue(demoPageContainer.appointmentsPage.selectPhoneCode(TestDataUtil.getValue(lstAppointmentDetails.get(7))));
    ...
    @Then("I should see the only show Pay Now Button on Send Script by Post{string},{string},{string} and {string},{string}")
    public void iShouldSeeTheOnlyShowPayNowButtonOnSendScriptByPostAnd(String strScriptInstruction, String ScriptUrgencies, String strMedicalDetails, String strLocationdetails, String strCarddetails) {
        List<String> lstscriptDetails = TestDataUtil.getListOfValue(strScriptInstruction);
        List<String> lstscriptUrgencies = TestDataUtil.getListOfValue(ScriptUrgencies);
        List<String> lstMedicalDetails = TestDataUtil.getListOfValue(strMedicalDetails);
        List<String> lstLocationDetails = TestDataUtil.getListOfValue(strLocationdetails);
...
//        Assert.assertTrue(demoPageContainer.repeatPrescription.verifyLocation(lstLocationDetails.get(0)));
    ...
    @Then("I should see the changes based on Deliver Meds By Pharmacy{string},{string},{string} and {string},{string}")
    public void iShouldSeeTheChangesBasedOnDeliverMedsByPharmacyAnd(String strScriptInstruction, String ScriptUrgencies, String strMedicalDetails, String strLocationdetails, String strRestrictProviderDetails) {

        List<String> lstscriptDetails = TestDataUtil.getListOfValue(strScriptInstruction);
        List<String> lstscriptUrgencies = TestDataUtil.getListOfValue(ScriptUrgencies);
        List<String> lstMedicalDetails = TestDataUtil.getListOfValue(strMedicalDetails);
        List<String> lstLocationDetails = TestDataUtil.getListOfValue(strLocationdetails);
        List<String> lstDetails = TestDataUtil.getListOfValue(strRestrictProviderDetails);
        System.out.println("RRPScriptFee details >>> :: " + lstLocationDetails);
        System.out.println("RRPScriptFee Instructions details >>> :: " + lstscriptDetails);
        System.out.println("RRPScript Urgencies details >>> :: " + lstscriptUrgencies);
...
//        Assert.assertTrue(demoPageContainer.repeatPrescription.selectTermsAndCondition());
    ...
    @When("I should see details of created appointment in My Appointments {string} {string} and I should see booked appointment displayed under the future tab {string}")
    public void iShouldSeeDetailsOfCreatedAppointmentInMyAppointmentsAndIShouldSeeBookedAppointmentDisplayedUnderTheFutureTab(String strAppointmentDetails, String strFutureDate, String strAppointmentSummary) {
        List<String> lstDetails = TestDataUtil.getListOfValue(strAppointmentDetails);
        List<String> lstDetail = TestDataUtil.getListOfValue(strAppointmentSummary);
        Assert.assertTrue(demoPageContainer.appointmentsPage.clickConfirmButton());
        Assert.assertTrue(demoPageContainer.appointmentsPage.verifyDetailsOfCreatedAppointment(lstDetails, (TestDataUtil.getValue(strFutureDate))));
