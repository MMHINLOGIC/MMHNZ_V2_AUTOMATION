...
public class AlternativeProviderPage extends BasePage {
    ...
    @FindBy(xpath = "//div[contains(text(),'Appointment Reasons')]")
    ...
    @FindBy(xpath = "(//mat-radio-group[@formcontrolname='AlternativeProiderIsEnable']//following::input)[1]")
    protected WebElement elmntAlternativeProiderIsEnable;
    @FindBy(xpath = "(//mat-radio-group[@formcontrolname='AlternativeProiderIsEnable']//following::input)[2]")
