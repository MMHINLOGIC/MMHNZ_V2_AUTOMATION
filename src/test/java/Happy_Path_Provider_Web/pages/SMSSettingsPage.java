...
public class SMSSettingsPage extends BasePage {
    ...
    protected String clickHealthCentre = new StringBuilder().append("//span[text()='")
    ...
    @FindBy(how = How.XPATH, using = "(//mat-radio-group[@name='IsSMSEnabled']//input)[1]")
    protected WebElement SelectGroupMessageYesButton;

    @FindBy(how = How.XPATH, using = "(//mat-radio-group[@name='IsSMSEnabled']//input)[2]")
    protected WebElement SelectGroupMessageNoButton;

    @FindBy(how = How.XPATH, using = "//p[contains(text(),'SMS Settings Saved Successfully.')]")
