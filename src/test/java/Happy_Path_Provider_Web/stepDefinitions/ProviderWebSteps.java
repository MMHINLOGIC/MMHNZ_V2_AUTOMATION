...
//        Assert.assertTrue(providerPageContainer.preScreeningPage.clickUpdateButton());
    ...
    public void iEnterTheLocationInSearchBoxAndIVerifyTheCreatedAppointment(String strLocation) {
        ...
        if (strEnv.equalsIgnoreCase("UAT")){
...
//        Assert.assertTrue(providerPageContainer.appointmentMessagePage.clickEditButton());
    ...
    public void iShouldVerifyTheBannerHeadingAndBannerMessagesAreNotDisplayed(String strBannerHeading, String strBannerMessage) {
        String strEnv = System.getProperty(Constants.ENV_VARIABLE_ENVIRONMENT);
        if (strEnv.equalsIgnoreCase("UAT")){
            Assert.assertTrue(providerPageContainer.appointmentMessagePage.verifyBannerHeadingIsNotDisplayed(TestDataUtil.getValue(strBannerHeading)));
            Assert.assertTrue(providerPageContainer.appointmentMessagePage.verifyBannerMessageIsNotDisplayed(TestDataUtil.getValue(strBannerMessage)));
        }
...
//        Assert.assertTrue(providerPageContainer.appointmentMessagePage.clickEditButton());
    ...
    public void iNavigateToProviderPortalAndVerifyTheReplyMessage(String lstMessageDetails) {
        ...
        Assert.assertTrue(providerPageContainer.providerMessagesPage.verifyProviderInboxMessages(TestDataUtil.getValue(lstMessage.get(5))));
    }
...
//        Assert.assertTrue(providerPageContainer.homePage.clickDashBoard());
    ...
    public void asAProviderIAmOnHomePageAndNavigateToAppointmentSettingPage() {
        Assert.assertTrue(providerPageContainer.providerHomePage.navigateToProviderHomepage());
        Assert.assertTrue(providerPageContainer.providerHomePage.clickSecureMessaging());
        Assert.assertTrue(providerPageContainer.providerHomePage.clickAppointmentSetting());
    }
    ...
    public void iLogOutFromProviderAndSearchForHealthCentreVerifyOnlineAppointmentIsNotDisplayedForEasyBookingAnd(String LocationData, String ProviderLoginData) {
        ...
        Assert.assertTrue(providerPageContainer.appointmentSettingPage.EnterValueinSearchBoxVerifyAppointmentsSlotIsNotDisplayed(TestDataUtil.getValue(LocationData)));
...
//        Assert.assertTrue(providerPageContainer.appointmentSettingPage.verifyAppointmentsAuditDetailsGridView(TestDataUtil.getValue(LocationData)));
    }
    ...
    public void iShouldSeeTurnOnAppointmentsAuditDetailsDisplayedGridView(String LocationData) {
        Assert.assertTrue(providerPageContainer.appointmentSettingPage.verifyTurnOnAppointmentsAuditDetailsGridView(TestDataUtil.getValue(LocationData)));
    }
    ...
    public void asAProviderIAmOnHomePageAndNavigateToPhoneAppointmentSettingPage() {
        ...
        Assert.assertTrue(providerPageContainer.phoneAppointmentSettingPage.clickSetupModule());
...
//        Assert.assertTrue(providerPageContainer.phoneAppointmentSettingPage.clickPhoneAppointmentSettingAutomationLoc1checkbox());
//        Assert.assertTrue(providerPageContainer.phoneAppointmentSettingPage.clickPhoneAppointmentSettingAutomationLocation2checkbox());
...
//        Assert.assertTrue(providerPageContainer.videoConsultationsSettingPage.EntertheMessage(data.get(2)));
    ...
    @And("I Disable face to face appointment on a Video Consultation slot by clicking yes button and I click save button then I see Saved Successfully message{string}")
    public void iDisableFaceToFaceAppointmentOnAVideoConsultationSlotByClickingYesButtonAndIClickSaveButtonThenISeeSavedSuccessfullyMessage(String LocationData) {
        Assert.assertTrue(providerPageContainer.videoConsultationsSettingPage.clickHealthCenterLocation(TestDataUtil.getValue(LocationData)));
...
//        Assert.assertTrue(providerPageContainer.appointmentMessagePage.selectHealthCentre(strHealthCentre));
    ...
    public void iFillPatientPortalMobileAppsBannerHeadingAndBannerMessageFields(String strBannerHeading, String strBannerMssg) {
        ...
        Assert.assertTrue(providerPageContainer.appointmentMessagePage.enterMobileAppsBannerMessage(TestDataUtil.getValue(strBannerMssg)));
        Assert.assertTrue(providerPageContainer.appointmentMessagePage.clickUpdateButton());
...
//        Assert.assertTrue(providerPageContainer.providerHomePage.clickSecureMessaging());
    ...
    public void asAProviderIAmOnHomePageAndNavigateToPreScreeningQuestionnairePage() {
        Assert.assertTrue(providerPageContainer.providerHomePage.navigateToProviderHomepage());
//        Assert.assertTrue(providerPageContainer.providerHomePage.clickSecureMessaging());
        Assert.assertTrue(providerPageContainer.preScreeningQuestionnairePage.clickPreScreeningQuestionnaire());
    }


    @And("I select Health center{string} and Location{string}")
    public void iSelectHealthCenterAndLocation(String Healthcentre, String Locations) {
        Assert.assertTrue(providerPageContainer.preScreeningQuestionnairePage.clickAppointmentReasonHealthCenterLocation(TestDataUtil.getValue(Healthcentre)));
        Assert.assertTrue(providerPageContainer.preScreeningQuestionnairePage.clickPreScreenQuesLocation(TestDataUtil.getListOfValue(Locations)));


    }

    @When("I Enter Pre-Screening Information to be displayed while booking appointment{string}")
    public void iEnterPreScreeningInformationToBeDisplayedWhileBookingAppointment(String TextboxData) {
        Assert.assertTrue(providerPageContainer.preScreeningQuestionnairePage.EnterPreScreeningInformation(TestDataUtil.getListOfValue(TextboxData)));

    }

    @Then("I select {string} and {string} and verify the Covid Pre-Screening popup is displayed")
    public void iSelectAndAndVerifyTheCovidPreScreeningPopupIsDisplayed(String strHealthCentre, String strLocation) {
        List<String>stsdta=TestDataUtil.getListOfValue(strLocation);
        Assert.assertTrue(providerPageContainer.appointmentsPage.verifyCovidPreScreeningQuestionnaire(stsdta.get(1)));
        Assert.assertTrue(providerPageContainer.appointmentsPage.selectHealthCenter(TestDataUtil.getValue(strHealthCentre)));
        Assert.assertTrue(providerPageContainer.appointmentsPage.verifyCovidPreScreeningQuestionnaire(stsdta.get(1)));
        Assert.assertTrue(providerPageContainer.appointmentsPage.selectLocation(TestDataUtil.getValue(stsdta.get(0))));
        Assert.assertTrue(providerPageContainer.appointmentsPage.verifyCovidPreScreeningQuestionnaire(stsdta.get(1)));
    ...
    public void iDisableAdditionalAssistanceTextboxAndEnableAccidentYesButton() {
        Assert.assertTrue(providerPageContainer.appointmentsPage.ProviderDisabledAdditionalAssistanceTextbox());
        Assert.assertTrue(providerPageContainer.appointmentsPage.ProviderDisabledAccidentInjuryOption());
        Assert.assertTrue(providerPageContainer.preScreeningPage.clickSaveButton());
    }
    ...
    public void iNavigateToAppointmentSettingPageVerifyThePayonlineOrPayhealthcentreOptionsDisplayedChooseThePayOnlineOption() {
        ...
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.veriflyPhoneAppoitmentPaymentSettings());
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.veriflyVideoAppoitmentPaymentSettings());
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.EnableVideoAppointmentPayOnlineOption());
        Assert.assertTrue(providerPageContainer.preScreeningPage.clickSaveButton());
    ...
    public void iNavigateToAppointmentSettingPageVerifyThePayonlineOrPayhealthcentreOptionsDisplayedAndChoosePayhealthcentreOption() {
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.clickSecureMessaging());
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.clickAppointmentSetting());
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.clickAppoitmentSettingEditButton());
        Assert.assertTrue(providerPageContainer.onlinePaymentsSettingPage.veriflyInpersonAppoitmentPaymentSettings());
    ...
    public void iEnableAdditionalAssistanceTextboxAndEnableAccidentYesButton() {
        Assert.assertTrue(providerPageContainer.appointmentsPage.ProviderEnabledAdditionalAssistanceTextbox());
