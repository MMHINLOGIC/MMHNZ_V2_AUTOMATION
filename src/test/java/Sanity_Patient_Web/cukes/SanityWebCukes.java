...
//clean test -Dapp=Sanity_Patient_Web -Dexecution_type=browser -Drunner=SanityWebCukes -Dbrowser_name=chrome -Denv=UAT "-DargLine=-Dextent.reporter.spark.out=reports/Extent-Report/WebApp-QAResults.html -Dsysteminfo.AppName=Demo-QA"