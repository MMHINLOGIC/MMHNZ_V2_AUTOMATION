...
#    Then I click SignIn button then I should see user successfully logs in to the MMH portal
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE @PROVIDER_SCRIPT3
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE1 @PROVIDER_SINGLE_SCREEN
  ...
  Scenario Template:S1-As a User I have to enable Easy Booking Banner Message to Yes in Appointment Message page
    ...
    And I select Health Center "<Health_Centre>" and I enable Banner Message to Yes
    And I fill Banner Heading "<Banner_Heading>" and Banner Message fields "<Banner_Message>"
    When I select Health Center "<Health_Centre>" and I enable Patient Portal Web Banner Message to yes
    And I fill Patient Portal Web Banner Heading "<Banner_Heading>" and Banner Message fields "<Banner_Message>"
    Then I should Verify the Appointment Message "<Health_Centre>" and "<Banner_Message>" details are saved
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE1 @PROVIDER_SINGLE_SCREEN1
  Scenario Template:S1-As a User I have to enable Easy Booking Banner Message to Yes in Appointment Message page

    Given As a user I am on Patient HomePage and I logout from the Patient login
    And I Enter the Location in search box and I verify the created Appointment "<Location>"
    When I click the Book Now button "<Location>"
    Then I should verify the Banner heading "<Banner_Heading>" and Banner Messages "<Banner_Message>" are saved

    Examples:
      | Banner_Heading   | Banner_Message   | Location                 |
      | &BANNER_HEADING& | &BANNER_MESSAGE& | &PRE_SCREENING_LOCATION& |
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE @PROVIDER_SINGLE_SCREEN
  Scenario Template:S1-As a User I have to enable Patient Portal(Web) Banner Message to yes in Appointment Message page

    Given As a user I am on HomePage and navigate to Book Appointment Page in Appointments
    When I navigate to Appointments Menu and I click the Book Appointment
    Then I should verify the Patient Portal Web Banner heading "<Banner_Heading>" and Banner Messages "<Banner_Message>" are displayed
  ...
  Scenario Template:S2-As a User I have to enable Easy Booking Banner Message to No in Appointment Message page
    ...
    And I select Health Center "<Health_Centre>" and I enable Banner Message to No
    And I fill Banner Heading "<Banner_Heading>" and Banner Message fields "<Banner_Message>"
    When I select Health Center "<Health_Centre>" and I enable Patient Portal Web Banner Message to No
    And I fill Patient Portal Web Banner Heading "<Banner_Heading>" and Banner Message fields "<Banner_Message>"
    Then I should Verify the Appointment Message "<Health_Centre>" and "<Banner_Message>" details are saved
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE @PROVIDER_SINGLE_SCREEN1
  Scenario Template:S2-As a User I have to enable Easy Booking Banner Message to No in Appointment Message page
