Feature: Appointment Message
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_SETTING @PROVIDER_SCRIPT2
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_MESSAGE @PROVIDER_SCRIPT2
  ...
  @WEB @PROVIDER_HAPPY_PATH1 @APPOINTMENTS_MESSAGE @PROVIDER_SCRIPT2
