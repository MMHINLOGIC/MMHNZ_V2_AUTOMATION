...
#    Then I click SignIn button then I should see user successfully logs in to the MMH portal
  ...
  @WEB @APPOINTMENTS_REASON1 @PROVIDER_HAPPY_PATH @PROVIDER_SINGLE_SCREEN
  ...
  @WEB @PROVIDER_HAPPY_PATH @APPOINTMENTS_REASON1 @PROVIDER_SINGLE_SCREEN
  Scenario Template: Prep- Canceling all the appointments
  ...
  @WEB @APPOINTMENTS_REASON1 @PROVIDER_SINGLE_SCREEN @PROVIDER_SINGLE_SCREEN
  Scenario Template: User Successfully logs in to the MMH Patient Portal.
