...
#    Then I click SignIn button then I should see user successfully logs in to the MMH portal
  ...
  @WEB @PROVIDER_HAPPY_PATH @VIDEO_CONSULTATIONS @PROVIDER_SCRIPT3
  ...
  @WEB @PROVIDER_HAPPY_PATH @VIDEO_CONSULTATIONS1 @PROVIDER_SINGLE_SCREEN
  ...
  Scenario Template:S1-Provider Video Consultations & Provider Search Booked Appointments
    ...
    Examples:
      | Appointment_Details      | Details_For_Appointment     | Future_Date   | Appointment_Summary         | Patient_User_Login | Password   |
      | &BOOK_VIDEO_APPOINTMENT& | &VIDEO_APPOINTMENT_DETAILS& | &FUTURE_DATE& | &VIDEO_APPOINTMENT_SUMMARY& | &EMAIL&            | &PASSWORD& |
  ...
  Scenario Template:S1-Provider Video Consultations & Provider Search Booked Appointments
    ...
    Given As a Provider I am on HomePage and navigate to Video Consultations page
    Then I should see Video consultations details in My appointments grid based on the select provider name "<My_Appointment_Details>"
